...
*date Mon Oct 31 18:27:56 2022  # latest file modification 
...
*surf,Wall-3,VERT,-,WALL,-,ext_wall_norway,OPAQUE,EXTERIOR,0,0  #   2 ||< external
*surf,Wall-4,VERT,-,WALL,-,ext_wall_norway,OPAQUE,EXTERIOR,0,0  #   3 ||< external
*surf,Top-5,CEIL,-,ROOF,FLAT,ext_roof,OPAQUE,EXTERIOR,0,0  #   4 ||< external
*surf,Base-6,FLOR,-,FLOOR,EXTGRND,floor_ground_floor,OPAQUE,GROUND,0,001  #   5 ||< user def grnd profile  1
*surf,1fBthWallSr,VERT,-,-,-,NONSYMMETRIC,OPAQUE,ANOTHER,010,002  #   6 ||< 1fBthWallSr:1fBath
*surf,extSrDoor,VERT,Wall-3,DOOR,CLOSED,ext_door,OPAQUE,EXTERIOR,0,0  #   7 ||< external
# 
