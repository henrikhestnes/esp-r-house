...
*date Fri Oct 28 18:26:34 2022  # latest file modification 
...
*surf,gfSrCeilBth,CEIL,-,PARTN,-,floor_divider,OPAQUE,UNKNOWN,000,000  #   3 ||< not yet defined
*surf,gfSrFlr,FLOR,-,FLOOR,EXTGRND,floor_ground_floor,OPAQUE,GROUND,001,001  #   4 ||< user def grnd profile  1
*surf,gfLrDoorSr,VERT,gfLrWallSr,DOOR,OPEN,int_doors,OPAQUE,ANOTHER,014,000  #   5 ||< gfLrDoorSr:gfLivRoom
...
*surf,gfSrCeilEnt,CEIL,-,PARTN,-,floor_divider,OPAQUE,UNKNOWN,000,000  #   9 ||< not yet defined
# 
